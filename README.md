...
```julia
run_driver(EulerDriver(p, p_g=p, p_quad=35, C_t=0.5,
    element_type="Tri", 
    scheme="ModalTensor", 
...
|---|---|---|
1 | 2D collapsed coordinate transformation  | [plot_collapsed_2d.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/plot_collapsed_2d.ipynb) 
2 | 3D collapsed coordinate transformation  | [plot_collapsed_3d.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/plot_collapsed_3d.ipynb) 
3 | Quadrature nodes for SBP operators | [plot_nodes_tri.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/plot_nodes_tri.ipynb) </br>[plot_nodes_tet.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/plot_nodes_tet.ipynb) 
4 | Number of entropy-conservative flux evaluations | [two_point_fluxes_tri.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/two_point_fluxes_tri.ipynb) </br>[two_point_fluxes_tet.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/two_point_fluxes_tet.ipynb) 
5 | Number of floating-point operations | [matrix_ops_tri.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/matrix_ops_tri.ipynb) </br>[matrix_ops_tet.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/matrix_ops_tet.ipynb) 
6 | Example meshes and mapping nodes | [plot_mesh_tri.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/plot_mesh_tri.ipynb) </br>[plot_mesh_tet.ipynb](https://github.com/tristanmontoya/EntropyStableDSEM/tree/main/notebooks/plot_mesh_tet.ipynb) 
